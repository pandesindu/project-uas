<div>
    ...
    <div class="max-w-7xl mx-auto py-2 sm:px-6 lg:px-8">
        @if($statusUpdate)
        <livewire:motor-update></livewire:motor-update>
        @elseif($statusDetail)
        <livewire:motor-detail></livewire:motor-detail>
        @elseif($statusAdd)
        <livewire:motor-create></livewire:motor-create>
        @else
    </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            {{number_format($data->modal, 0, ',','.')}}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">


                                            <img src="{{asset ('storage/'.$data->cover)}}" alt="" class=" w-40">
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <button wire:click="getMotor({{$data->id}})"
