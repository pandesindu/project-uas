<div>
    <!-- <div>
        <h1 class="text-xl my-2 mx-4 uppercase font-bold">Tambah Data</h1>
    </div> -->
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="plat_nomor" value=""
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <input type="text" name="nama_motor" value=""
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <input type="text" name="tahun_kendaraan" value=""
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('warna') border-red-500 @enderror">
                            <div class="text-xs text-red-500"></div>
                        </div>
